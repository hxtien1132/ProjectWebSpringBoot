...
public class ProfileController extends CommomController{
	...
	// xem chi tiết đơn hàng người dùng mua gì 
...
//		model.addAttribute("menuO", "menu");
	...
	public ModelAndView cancel(ModelMap model, @PathVariable("order_id") Long id) {// hủy đơn theo id 
		Optional<Order> o = orderRepository.findById(id);
		if (o.isEmpty()) {
			return new ModelAndView("redirect:/profile", model);
		}
		Order oReal = o.get();
		oReal.setStatus((short) 3);// 3 hủy , 2 đang giao , 1 đã thanh toán 
